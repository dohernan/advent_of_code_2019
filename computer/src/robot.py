    ...
    def compute(self):#computes until there's an input requiered
        ...
        while(True):
            ...
            if(OpCode=="01"):
                ...
                print(str(self.index) +"output from int comp "+str(self.id)+ "  :" +str(self.memory[parameters[0]]))
               ...
               # print("went here")
                ...
                print(str(self.index)+str(self.id)+ ". computer has finished")
                self.finished=True
                break
...
data = open("day11/data/input.txt").read().split(",")
